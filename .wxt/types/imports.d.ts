...
declare global {
  ...
  const initializeApp: typeof import('K:/git/czynsz_ff/src/utils/app-init')['initializeApp']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AppInitOptions, InitializedApp } from 'K:/git/czynsz_ff/src/utils/app-init'
  import('K:/git/czynsz_ff/src/utils/app-init')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly initializeApp: UnwrapRef<typeof import('K:/git/czynsz_ff/src/utils/app-init')['initializeApp']>
